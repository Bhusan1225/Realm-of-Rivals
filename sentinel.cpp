...
sentinel::sentinel()
{
	cout << "hy i am sentinel." << endl;
}


int sentinel::attack(worriers& target)
{
	//attack logic
...
int sentinel::takeDamage(int takeDamage)
{
...
int sentinel::SurpriseMove(int min_S_Damage, int max_S_Damage, worriers& target)
{
...
int sentinel::heal(int minheal, int maxheal)
{
